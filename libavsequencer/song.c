...
int avseq_song_reset(AVSequencerContext *avctx, AVSequencerSong *song)
{
    ...
    player_globals->flags                       &= AVSEQ_PLAYER_GLOBALS_FLAG_PLAY_ONCE|AVSEQ_PLAYER_GLOBALS_FLAG_NO_PROC_PATTERN|AVSEQ_PLAYER_GLOBALS_FLAG_PLAY_PATTERN;
    player_globals->speed_slide_to                  = 0;
    player_globals->play_time                       = 0;
    player_globals->play_time_frac                  = 0;
    player_globals->play_tics                       = 0;
    player_globals->play_tics_frac                  = 0;
    player_globals->global_volume_slide_to          = 0;
    player_globals->global_pan_slide_to             = 0;
    player_globals->speed_slide_faster              = 0;
    player_globals->speed_slide_slower              = 0;
    player_globals->fine_speed_slide_fast           = 0;
    player_globals->fine_speed_slide_slow           = 0;
    player_globals->speed_slide_to_slide            = 0;
    player_globals->speed_slide_to_speed            = 0;
    player_globals->spenolo_slide                   = 0;
    player_globals->spenolo_depth                   = 0;
    player_globals->spenolo_rate                    = 0;
    player_globals->global_vol_slide_up             = 0;
    player_globals->global_vol_slide_down           = 0;
    player_globals->fine_global_vol_sl_up           = 0;
    player_globals->fine_global_vol_sl_down         = 0;
    player_globals->global_volume_slide_to_slide    = 0;
    player_globals->global_volume_sl_to_volume      = 0;
    player_globals->global_volume_sl_to_sub_volume  = 0;
    player_globals->tremolo_slide                   = 0;
    player_globals->tremolo_depth                   = 0;
    player_globals->tremolo_rate                    = 0;
    player_globals->global_pan_slide_left           = 0;
    player_globals->global_pan_slide_right          = 0;
    player_globals->fine_global_pan_sl_left         = 0;
    player_globals->fine_global_pan_sl_right        = 0;
    player_globals->global_pan_slide_to_slide       = 0;
    player_globals->global_pan_slide_to_panning     = 0;
    player_globals->global_pan_slide_to_sub_panning = 0;
    player_globals->pannolo_slide                   = 0;
    player_globals->pannolo_depth                   = 0;
    player_globals->pannolo_rate                    = 0;
    player_globals->channels                        = 0;
    player_globals->max_channels                    = 0;
    player_globals->speed_type                      = 0;

    memset(&player_globals->spenolo_env, 0, sizeof(AVSequencerPlayerEnvelope));
    memset(&player_globals->tremolo_env, 0, sizeof(AVSequencerPlayerEnvelope));
    memset(&player_globals->pannolo_env, 0, sizeof(AVSequencerPlayerEnvelope));
    ...
    if ((module == avctx->player_module) && (song == avctx->player_song)) {
        AVMixerData *mixer_data = avctx->player_mixer_data;
    ...
    for (i = song->channels; i > 0; i--) {
        ...
        player_host_channel->track_sub_volume       = order_list->sub_volume;
        player_host_channel->track_panning          = order_list->channel_panning;
        player_host_channel->track_sub_panning      = order_list->channel_sub_panning;
        player_host_channel->track_note_panning     = order_list->channel_panning;
        player_host_channel->track_note_sub_panning = order_list->channel_sub_panning;
